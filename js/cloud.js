...
const Cloud = (() => {
  ...
  return { enabled, init, profile, user: () => user, signUp, signIn, signOut, resetPassword, changePassword, deleteAccount, saveProfile, pushCreation, deleteCreation, pullCreations, friendly };
})();
